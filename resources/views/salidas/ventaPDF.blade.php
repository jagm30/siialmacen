...
<div id="firmas" style="display: flex;
  align-items: flex-end;">
    ...
    height: auto;">
    <hr>
        <table style="font-size: 7pt" style="border: none 1px;">
            <tr>
                <th colspan="5" style="font-size: 9pt"> Observaciones: {{ $salida->observaciones }}</th>
            </tr>
            <tr>
                <th colspan="3" style="font-size: 9pt">Cantidad a pagar con letra:  {{Convertidor::numtoletras($salida->total)}}</th>
                <th style="font-size: 9pt;">Subtotal: </th>
                <th style="font-size: 9pt;"><b>$ {{ number_format($totalpagar[0]->totalpagar,2) }}</b></th>
            </tr>
            <tr>
                <th colspan="2" style="font-size: 9pt;">Forma de pago:
                ...
                <th style="font-size: 9pt;">Comisiones: </th>
                <th style="font-size: 9pt;">$ {{ number_format($salida->total - $totalpagar[0]->totalpagar,2) }}</th>
            </tr>
            <tr style="border: none 1px;font-size: 9pt;">
                <th>Cantidad de articulos: <b>{{ $totalarticulos[0]->totalarticulos }} </b></th>
                <th style=" font-size: 9pt;text-align: right;"></th>
                <th style=" font-size: 9pt;border: none 1px;"></th>
