          ...
          <div class="row">
            <div class="col-md-2">
              <div class="form-group">
                ...
                <input id="solicitante" type="text" class="form-control" name="solicitante"   value="{{$salida->solicitante}}">                
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <label class="control-label" for="inputError1">Fecha de venta</label>
                <input id="fecha" type="date" class="form-control" name="fecha"   value="{{$salida->fecha}}">
              </div>             
            </div>
            ...
            <div class="col-md-2">
              ...
              <div class="form-group">
                ...
                <input id="referencia" type="text" class="form-control" name="referencia"  value="{{$salida->observaciones}}">
              </div>
              <!-- /.form-group -->
            </div>
            <div class="col-md-2">
