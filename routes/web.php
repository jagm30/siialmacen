...
Route::get('productos/edicion/{id_producto}/{nombre}/{talla}/{claveproducto}/{descripcion}/{categoria}/{precio}/{precioPromocion}/{status}',[App\Http\Controllers\ProductoController::class,'edicion'])->name('edicion');
